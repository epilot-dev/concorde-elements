...
export const MobileStepper = forwardRef<HTMLDivElement, MobileStepperProps>(
  (props, ref) => {
    ...
    const customColors: MobileStepperCSSProperties = {
      '--mobile-stepper-color': color,
      '--mobile-stepper-background-color': backgroundColor,
      '--mobile-stepper-step-background-color': stepBgColor,
      '--mobile-stepper-active-step-background-color': activeStepBgColor
    }
