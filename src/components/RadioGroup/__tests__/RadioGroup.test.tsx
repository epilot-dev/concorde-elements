...
describe('RadioGroup', () => {
  describe('aria attributes', () => {
    it('forwards isRequired to aria-required on the radio group', () => {
      render(
    ...
    it('sets aria-required to false when isRequired is not provided', () => {
      render(
  ...
  describe('accessibility > axe static tests', () => {
    ...
    it('with required state', async () => {
      const { container } = render(
        <RadioGroup aria-label="Choose option" defaultValue="A" isRequired>
          <Radio label="Option A" value="A" />
          <Radio label="Option B" value="B" />
          <Radio label="Option C" value="C" />
        </RadioGroup>
