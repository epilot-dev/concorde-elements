...
describe('Button', () => {
  ...
  describe('fullWidth', () => {
    test('marks the button as full width', () => {
      const { getByRole } = render(
        <Button fullWidth label="Button" variant="primary" />
      )

      expect(getByRole('button')).toHaveClass('Concorde-Button__FullWidth')
    })

    test('keeps the button fit-content by default', () => {
      const { getByRole } = render(<Button label="Button" variant="primary" />)

      expect(getByRole('button')).not.toHaveClass('Concorde-Button__FullWidth')
    })
  })
})
