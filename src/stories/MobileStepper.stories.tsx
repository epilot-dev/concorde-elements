...
import { Icon, MobileStepper } from '..'
import type { MobileStepperCSSProperties, MobileStepperProps } from '..'
import { List, ListItem, ListItemContent } from '../../../journey-elements/src'
...
const CUSTOM_TOKENS: MobileStepperCSSProperties = {
  '--mobile-stepper-color': 'string',
  '--mobile-stepper-background-color': 'string',
  '--mobile-stepper-step-background-color': 'string',
  '--mobile-stepper-active-step-background-color': 'string'
}
