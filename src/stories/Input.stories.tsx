...
import { Container, CustomTokensWrapper, Section } from './components'
...
/**
 * A large corner radius pushes the rounded border into the space the floating
 * label and its notch occupy. Every state below must keep the corner arc
 * intact and the notch clear of it. See STABLE360-12728.
 */
  ...
  return (
    <Container>
      <div style={{ display: 'grid', gap: 24, width: 320 }}>
        ...
        <Input
          borderRadius={radius}
          id="large-radius-outlined"
          label="Outlined"
          value="Hello"
        />
        <Input
          borderRadius={radius}
          id="large-radius-required"
          isRequired
          label="Required"
          value="Hello"
        />
        <Input
          borderRadius={radius}
          id="large-radius-adorned"
          label="Start adornment"
          startAdornment={<Icon name="info" />}
          value="Hello"
        />
        <Section title="Unaffected by the radius" />
        <Input
          borderRadius={radius}
          id="large-radius-resting"
          label="Resting"
          placeholder=""
        />
        <Input
          borderRadius={radius}
          id="large-radius-filled"
          label="Filled"
          value="Hello"
          variant="filled"
        />
