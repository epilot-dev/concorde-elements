...
describe('getContrastRatio', () => {
  ...
  test('returns similar contrast ratio for same opaque colors regardless of case', () => {
  ...
  test('handles same color with different alpha values in contrast calculation', () => {
    const ratioOpaqueVsSemi = getContrastRatio('#FF0000', '#FF000000')

    expect(ratioOpaqueVsSemi).toBeGreaterThan(3.5)
  })

  test('handles two semi-transparent colors with different opacities', () => {
...
describe('getAlphaContrastRatio', () => {
  test('returns a contrast ratio of 1 when a fully transparent color composites to white', () => {
    const ratio = getAlphaContrastRatio('#aaaaaa00', '#ffffff')

    expect(ratio).toBeCloseTo(1, 2)
  })

  test('computes a contrast ratio for semi-transparent black over white', () => {
  ...
  test('handles both colors having alpha channels', () => {
  ...
  test('returns high contrast for dark vs light colors with alpha', () => {
    const ratio = getAlphaContrastRatio('#00008080', '#ffff0080')

    expect(ratio).toBeGreaterThan(3)
  })

  test('handles same color with different alpha values', () => {
  ...
  test('falls back to default (white vs white) when given an invalid hex', () => {
