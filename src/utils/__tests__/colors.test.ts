...
describe('generateLightColor', () => {
  it('should generate a light color', () => {
    ...
    expect(generateLightColor('#005EB4')).toBe('#e2ecf9')
    expect(generateLightColor('#000000')).toBe('#f7e6ea')
    expect(generateLightColor('#0ac005aa')).toBe('#c5fdbf')
  })

  it("should remove '!important' and still convert correctly", () => {
    expect(generateLightColor('#005EB4 !important')).toBe('#e2ecf9')
    expect(generateLightColor('#000000 !important')).toBe('#f7e6ea')
  })
...
describe('generateColorShades', () => {
  it('should generate color shades', () => {
    ...
    expect(redShades).toContain(`primary-50: #ffd3bf;`)
    expect(redShades).toContain(`primary-100: #ffb6a2;`)
    ...
    expect(blueShades).toContain(`primary-50: #d0e9ff;`)
    expect(blueShades).toContain(`primary-100: #afd5ff;`)
